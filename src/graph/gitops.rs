...
pub fn get_hunks_all_files(prev_commit: &str, curr_commit: &str, clone_dir: &str) -> Option<HunkDiffMap> {
...
// pub fn get_test_diff_graph(review: &Review) -> DiffGraph {
//     let mut file_line_map = HashMap::new();

//     file_line_map.insert(
//         format!("{}/src/cli/server/mod.rs", review.clone_dir()),
//         FileHunks {
//             deleted_hunks: vec![],
//             added_hunks: vec![HunkDiffLines {
//                 start_line: 1,
...
//     file_line_map.insert(
//         format!("{}/src/core/primitive.rs", review.clone_dir()),
//         FileHunks {
//             deleted_hunks: vec![HunkDiffLines {
//                 start_line: 2,
//                 end_line: 2,
//                 function_line: Some("use std::marker::PhantomData;".to_string()),
//                 line_number: Some(1),
//                 function_name: Some("PhantomData".to_string()),
//             }],
//             added_hunks: vec![
//                 HunkDiffLines {
//                     start_line: 2,
...
//                     start_line: 19,
//                     end_line: 19,
//                     function_line: Some("impl Primitive for u16 {}".to_string()),
//                     line_number: Some(18),
//                     function_name: Some("impl Primitive for u16".to_string()),
//                 },
//             ],
//         },
//     );
...
//     file_line_map.insert(
//         format!("{}/src/core/config/server.rs", review.clone_dir()),
//         FileHunks {
//             deleted_hunks: vec![],
//             added_hunks: vec![],
//         },
...
//     file_line_map.insert(
//         format!("{}/src/cli/server/http_server.rs", review.clone_dir()),
//         FileHunks {
//             deleted_hunks: vec![HunkDiffLines {
//                 start_line: 56,
//                 end_line: 56,
//                 function_line: Some("impl Server {".to_string()),
//                 line_number: Some(20),
//                 function_name: Some("Server".to_string()),
//             }],
//             added_hunks: vec![
//                 HunkDiffLines {
//                     start_line: 7,
//                     end_line: 7,
//                     function_line: Some("use tokio::sync::oneshot::{self};".to_string()),
//                     line_number: Some(5),
//                     function_name: None,
//                 },
//                 HunkDiffLines {
...
//     let mut added_files_map = HashMap::new();
//     added_files_map.insert(
//         format!("{}/src/cli/server/admin_server/server.rs", review.clone_dir()),
//         vec![],
//     );
//     added_files_map.insert(
//         format!("{}/src/cli/server/admin_server/graphql.rs", review.clone_dir()),
//         vec![],
//     );
//     added_files_map.insert(
//         format!("{}/src/cli/server/admin_server/mod.rs", review.clone_dir()),
//         vec![],
//     );

//     let hunk_diff_map = HunkDiffMap {
//         file_line_map,
//         added_files_map,
//         deleted_files_map: HashMap::new(),
//     };
//     DiffGraph { hunk_diff_map }
// }